...
class ChessBoardAnalyzer {
	...
	public static void main(String[] args) throws IOException {
		...
		while (in.hasNextLine()) {
			...
			String moveResults = analyzeMove(board, line2);
			String checkmateResults = analyzeCheckmate();
	...
	// //If chess board is valid, return string of chess piece type at query
	// square and attacking pieces with their location
	...
	// String valid = board.querySquare(col, row) + " " +
	// board.determineAttackPieces();
	// return valid;
	// }
	//
	// return "Invalid";
	...
	static String analyzeCheckmate() {
		// Return "Black/White in check" OR "Black/White checkmated" OR "All
		// kings safe"
		return "Check";
	}
